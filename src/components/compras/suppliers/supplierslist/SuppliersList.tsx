      ...
      <table className="min-w-full text-sm text-left">
        <thead className="bg-gray-100 text-gray-700 uppercase">
          <tr>
            ...
            <th className="px-2 py-2">Nombre representante</th>
            <th className="px-2 py-2">Telefono</th>
            <th className="px-2 py-2">Compras Totales</th>
            <th className="px-2 py-2">Ultima Fecha</th>
            <th className="px-2 py-2">Realizar compra</th>
